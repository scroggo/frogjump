...
use godot::classes::{AnimatedSprite2D, Label, Time};
use godot::prelude::*;
...
struct Tutorial {
    #[export]
    one_start_jump_ms: i32,
    #[export]
    two_release_jump_ms: i32,
    #[export]
    three_show_arrow_ms: i32,
    #[export]
    four_reset_ms: i32,
    #[export]
    five_start_jump_ms: i32,
    #[export]
    six_release_jump_ms: i32,
    #[export]
    seven_show_arrow_ms: i32,
    #[export]
    eight_reload_ms: i32,
...
impl INode2D for Tutorial {
    fn init(base: Base<Node2D>) -> Self {
        Self {
            one_start_jump_ms: 500,
            two_release_jump_ms: 200,
            three_show_arrow_ms: 1200,
            four_reset_ms: 1000,
            five_start_jump_ms: 500,
            six_release_jump_ms: 600,
            seven_show_arrow_ms: 2000,
            eight_reload_ms: 1000,
            next_step_time_ms: u64::default(),
    ...
    fn ready(&mut self) {
        ...
        self.next_step_time_ms = Time::singleton().get_ticks_msec() + self.one_start_jump_ms as u64;
